...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _services_AppService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/AppService */ \"./src/assets/js/services/AppService.js\");\n/* harmony import */ var _services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/DOMLoader */ \"./src/assets/js/services/DOMLoader.js\");\n/* harmony import */ var _DataController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DataController */ \"./src/assets/js/controllers/DataController.js\");\n/* harmony import */ var _UIController__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UIController */ \"./src/assets/js/controllers/UIController.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n/* eslint-disable @typescript-eslint/explicit-module-boundary-types */\n\n\n\n\n\nclass EventController {\n  static init() {\n    // Popover effect\n    $(document).mousedown(function (event) {\n      if (!document.querySelector(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.btn).contains(event.target)) {\n        $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.container).removeClass('active');\n        $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.list).fadeOut(200);\n      }\n    });\n    $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.filterItemBtn).each(function () {\n      $(this).on('click', function () {\n        var iconEl = $(this).find('.collapsible-icon');\n        var contentEl = $(this).siblings('.collapsible-item__content');\n\n        if (iconEl.hasClass('collapsed')) {\n          iconEl.removeClass('collapsed');\n          contentEl.removeClass('collapsed');\n          var height = contentEl.prop('scrollHeight');\n          contentEl.css('transition', 'height 0.35s ease-in-out');\n          contentEl.css('height', height);\n          contentEl.on('transitionend', function () {\n            contentEl.off('transitionend');\n            contentEl.css('height', 'auto');\n          });\n        } else {\n          iconEl.addClass('collapsed');\n\n          var _height = contentEl.prop('scrollHeight');\n\n          requestAnimationFrame(function () {\n            contentEl.css('height', _height);\n            requestAnimationFrame(function () {\n              contentEl.css('height', 0);\n              contentEl.addClass('collapsed');\n            });\n          });\n        }\n      });\n    });\n    $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.filterKey).each(function () {\n      $(this).on('click', /*#__PURE__*/_asyncToGenerator(function* () {\n        var dataTag = $(this).attr('data-tag');\n        if (!dataTag) return;\n        var {\n          tags,\n          sortBy\n        } = _DataController__WEBPACK_IMPORTED_MODULE_2__.default.getData();\n\n        if ($(this).hasClass('is-selected')) {\n          $(this).removeClass('is-selected');\n          var tagIndex = tags.findIndex(tag => tag === dataTag);\n          tags.splice(tagIndex, 1);\n        } else {\n          $(this).addClass('is-selected');\n          tags.push(dataTag);\n        }\n\n        var apiQueryString = _services_AppService__WEBPACK_IMPORTED_MODULE_0__.default.genAPIqueryString(tags, sortBy);\n        var webQueryString = _services_AppService__WEBPACK_IMPORTED_MODULE_0__.default.genWebqueryString(tags, sortBy);\n        history.pushState({}, null, webQueryString);\n        _UIController__WEBPACK_IMPORTED_MODULE_3__.default.initLoadingBar();\n        var products = (yield axios.get(apiQueryString)).data;\n        _UIController__WEBPACK_IMPORTED_MODULE_3__.default.removeLoadingBar();\n        _UIController__WEBPACK_IMPORTED_MODULE_3__.default.renderProductList(products);\n        _DataController__WEBPACK_IMPORTED_MODULE_2__.default.refreshData();\n        $('.pagination').remove();\n        document.querySelector('.section-capsules').scrollIntoView({\n          behavior: 'smooth'\n        });\n      }));\n    });\n    $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.btn).on('click', function () {\n      if ($(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.container).hasClass('active')) {\n        $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.container).removeClass('active');\n        $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.list).fadeOut(200);\n      } else {\n        $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.container).addClass('active');\n        $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.list).fadeIn(200);\n      }\n    });\n    $(_services_DOMLoader__WEBPACK_IMPORTED_MODULE_1__.default.popover.item).on('click', /*#__PURE__*/_asyncToGenerator(function* () {\n      var dataSort = $(this).attr('data-sort');\n      if (!dataSort) return;\n      var {\n        tags\n      } = _DataController__WEBPACK_IMPORTED_MODULE_2__.default.getData();\n      var apiQueryString = _services_AppService__WEBPACK_IMPORTED_MODULE_0__.default.genAPIqueryString(tags, dataSort);\n      var webQueryString = _services_AppService__WEBPACK_IMPORTED_MODULE_0__.default.genWebqueryString(tags, dataSort);\n      history.pushState({}, null, webQueryString);\n      _UIController__WEBPACK_IMPORTED_MODULE_3__.default.initLoadingBar();\n\n      try {\n        _UIController__WEBPACK_IMPORTED_MODULE_3__.default.initLoadingBar();\n        var productReponse = yield axios.get(apiQueryString);\n        _UIController__WEBPACK_IMPORTED_MODULE_3__.default.removeLoadingBar();\n        _UIController__WEBPACK_IMPORTED_MODULE_3__.default.renderProductList(productReponse.data);\n        _DataController__WEBPACK_IMPORTED_MODULE_2__.default.refreshData();\n        $('.pagination').remove();\n        document.querySelector('.section-capsules').scrollIntoView({\n          behavior: 'smooth'\n        });\n      } catch (e) {\n        console.error(e);\n        return;\n      }\n    }));\n  }\n\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (EventController);\n\n//# sourceURL=webpack://nest-shopify-collection/./src/assets/js/controllers/EventController.js?");
